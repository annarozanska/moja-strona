export const Sowa = (props) => {
  return (
<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sowa" role="img"
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512" {...props}>
